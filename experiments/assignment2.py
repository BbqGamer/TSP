...
from tsp import TSP
from tsp.solvers import GreedyCycle, NNHead, NNWhole, RandomSolver, RegretGreedyCycle, WeightedRegretGreedyCycle
...
if __name__ == "__main__":
    ...
    for filename in ["TSPA.csv", "TSPB.csv"]:
        ...
        for solverc in [RandomSolver, NNHead, NNWhole, GreedyCycle, RegretGreedyCycle, WeightedRegretGreedyCycle]:
            for i in range(20):
                starting_node = i
    ...
    with open("results/assignment2.csv", "w") as f:
